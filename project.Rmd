...
>>>>>>> e74455abdda02c63759edef3466165f42bd51ab9
...
<<<<<<< HEAD
#Data Vizualizations
# neighborhood.price.range = ggplot(data_train, aes(x = log(price), y = reorder(Neighborhood, desc(log(price)), median))) +
#   geom_polygon(color="Black",size = 1, alpha=1) + geom_point(stat="identity", aes(color="red3"), size=1.5) + theme_light() + coord_flip() + theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5)) + labs(y="Neighborhood")
=======
#Data Vizes
