...
quality.plot = ggplot(data_train, aes(x = Overall.Qual, y=price)) + geom_smooth(color="yellow") + geom_count(color="red3") + theme_bw() + labs(x="Overall Quality", y="Price", title="Price by Overall Quality") + theme(plot.title = element_text(hjust=0.5))
