...
area.plot = treemap(tree.data, index=c("price.bin", "price"), vSize="Lot.Area", type="index", palette="YlGn", algorithm="squarified", title="Effect of Lot Area on Price Range", fontsize.title = 14, fun.aggregate="mean")
