...
The 18 most imortant predictors are summarized in the following table. As one would expect (and mirroring the conclusions from the simple model), we  
...
* Variable selecidtion/shrinkage: must use appropriate method and include an explanation
