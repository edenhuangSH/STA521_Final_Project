...
Instructions: must include a summary of results and a discussion of things learned
  ...
  Finally, we also learned some things along the way about the most important predictors of housing prices. From our model, and boosting in particular, we found that a house's overall quality, its neighborhood, and its total square footage were the most important predictors in our model. While this makes intuitive sense, seeing the relative importance from actual data helped clarify the most important inputs to housing price.
  

### Appendix

One of the team members was really into making graphs that were rejected by the rest of the team. As a token of appreciation for energetic team member, we include their visualizations as an appendix.
